 ...
 * @since 0.1.0
 */
public final class AltruistConsumer extends AbstractConsumer {
     ...
     */
    public AltruistConsumer(UUID id, String name) {
        super(id, name);
    }
    ...
    public synchronized boolean acceptOffer(UUID exchangeAdId, UUID initiator,
        ...
        return super.acceptOffer(exchangeAdId, initiator, offer);
    }
